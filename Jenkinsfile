pipeline {
    ...
    stages {
        stage('Build') {
            steps {
                echo 'building....'
                bat "gradle widgets:clean billing:clean api:clean app:clean widgets:assembleDebug api:assembleDebug billing:assembleDebug app:assemblePureDebug"
            }
        }
        stage('Test build') {
            steps {
        ...
        stage('Test') {
            steps {
                echo 'test'
                bat "gradle app:testPureDebugUnitTest"
            }
        }
